...
const propTypes = {
  ...
  /**
   * 是否展示 zoom 缩放按钮 android 目前添加
   */
  showZoomControlsEnabled: PropTypes.bool,
  /**
...
const AMapLite = NativeModules.UIManager.AMapLite &&
  requireNativeComponent('AMapLite', MapView, {
    nativeOnly: {
      onChange: true,
      onMapReady: true,
      handlePanDrag: true,
